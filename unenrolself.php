...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'zarinpal'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/zarinpal/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_zarinpal', format_string($course->fullname));
